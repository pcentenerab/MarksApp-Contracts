...
contract FTEL {
    ...
    constructor(string memory _acronimo, string memory _nombre, string memory _curso) public {
    ...
    function setEvaluacion(string memory _nombre, uint _fecha, uint _puntos) soloProfesor public returns (uint) {
    ...
    function setMatricula(string memory _nombre, string memory _email) noMatriculados public {
    ...
    function setNota(address alumno, uint evaluacion, TipoNota tipo, uint calificacion) soloProfesor public {
    ...
    function getNota(uint evaluacion) soloMatriculados public view returns (TipoNota tipo, uint calificacion) {
